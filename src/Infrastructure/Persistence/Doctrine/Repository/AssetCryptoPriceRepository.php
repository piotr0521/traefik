...
final class AssetCryptoPriceRepository extends ResourceRepository
{
    ...
    public function findLastByAssetsAndBeforeDate(array $assetIds, DateTime $before): array
    {
        ...
        $rsm->addEntityResult(AssetCryptoPrice::class, 'asp');
        ...
        $query = $this->_em->createNativeQuery('
            WITH t1 AS ( 
                ...
                ) AS rank FROM asset_crypto_price WHERE priced_at <= :before AND asset_id IN (:ids)
