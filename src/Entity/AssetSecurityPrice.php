...
class AssetSecurityPrice implements ResourceInterface, AssetPriceHistoryInterface
{
    use ResourceTrait;
    use Creatable;
    use MoneyAwareTrait;
    ...
    #[ManyToOne(targetEntity: AssetSecurity::class)]
    #[JoinColumn(nullable: false, onDelete: 'CASCADE')]
    protected ?AssetSecurity $asset = null;
    ...
    public function getAsset(): ?AssetSecurity
    {
        return $this->asset;
    }

    public function setAsset(AssetSecurity $asset): void
    {
        $this->asset = $asset;
    }
